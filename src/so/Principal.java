...
public class Principal extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Heap h = new Heap(TamHeap, Integer.parseInt(t_limiarMax.getText()));
        this.fila = new FilaCircular(TamReq, Integer.parseInt(t_valorMin.getText()), Integer.parseInt(t_valorMax.getText()), h); 
